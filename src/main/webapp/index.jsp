...
<body>
    ...
    <section class="features">
      ...
      <div class="feat-row">
        <div class="feat-row__img reveal reveal--left">
          <div class="feat-row__img-inner">
            <img src="${pageContext.request.contextPath}/images/red.png" alt="Email-verified registration">
          </div>
        </div>
      ...
      <div class="feat-row feat-row--flip">
        <div class="feat-row__img reveal reveal--right">
          <div class="feat-row__img-inner">
            <img src="${pageContext.request.contextPath}/images/user.jpg" alt="Role-based login">
          </div>
        </div>
      ...
      <div class="feat-row">
        <div class="feat-row__img reveal reveal--left">
          <div class="feat-row__img-inner">
            <img src="${pageContext.request.contextPath}/images/contest.png" alt="Contester applications">
          </div>
        </div>
        <div class="feat-row__text reveal reveal--right reveal-d1">
      ...
      <div class="feat-row feat-row--flip">
        <div class="feat-row__img reveal reveal--right">
          <div class="feat-row__img-inner">
            <img src="${pageContext.request.contextPath}/images/us.png" alt="Position cap rule">
          </div>
        </div>
        <div class="feat-row__text reveal reveal--left reveal-d1">
      ...
      <div class="feat-row feat-row--flip">
        <div class="feat-row__img reveal reveal--right">
          <div class="feat-row__img-inner">
            <img src="${pageContext.request.contextPath}/images/profiles.png" alt="Profile management">
          </div>
        </div>
        <div class="feat-row__text reveal reveal--left reveal-d1">
  ...
  (function () {
    ...
    var observer = new IntersecstionObserver(function(entries) {
