...
public class Contester {
    ...
    public ContesterStatus getStatus() { return status; }
    public void setStatus(ContesterStatus status) { this.status = status; }
    public String getManifesto() { return manifesto; }
    public void setManifesto(String manifesto) { this.manifesto = manifesto; }
    public Position getRequestedPosition() { return requestedPosition; }
    public void setRequestedPosition(Position requestedPosition) { this.requestedPosition = requestedPosition; }
}
